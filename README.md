...
- Free / Pro / Team entitlement helper、billing profile、watchlist + saved views 数据模型、Stripe portal / lifecycle sync
...
- 商业化已经有 billing profile、portal、watchlist 和 saved views gating，但导出报告、团队协作和订阅运营闭环还没补齐
