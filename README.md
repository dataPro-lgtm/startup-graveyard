...
- Saved View 可生成公开 research brief 分享页，便于对外发送研究快照
- 账号中心：订阅状态、有效权限概览、账单入口、已保存 watchlist / saved views、带 seat / billing 状态的 Team Workspace 协作面板
...
- Free / Pro / Team entitlement helper、billing profile、watchlist + saved views + public brief share + team workspace 数据模型、seat-aware workspace billing state、workspace entitlement inheritance、Stripe portal / lifecycle sync、Markdown report export、Team Workspace ops metrics
...
- 商业化已经有 billing profile、portal、watchlist、saved views、Markdown brief export、public brief share、Team Workspace 基础协作、seat / billing 风险可见性、workspace entitlement inheritance 和 team ops metrics，但 PDF 交付、团队账单生命周期和更完整的订阅运营闭环还没补齐
