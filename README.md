...
- 账号中心：订阅状态、有效权限概览、账单入口、已保存 watchlist / saved views、带 seat / billing 状态与自动补偿提示的 Team Workspace 协作面板
...
- Free / Pro / Team entitlement helper、billing profile、watchlist + saved views + public brief share + team workspace 数据模型、seat-aware workspace billing state、workspace entitlement inheritance、workspace downgrade compensation、Stripe portal / lifecycle sync、Markdown / PDF report export、Team Workspace ops metrics
...
- 商业化已经有 billing profile、portal、watchlist、saved views、Markdown / PDF brief export、public brief share、Team Workspace 基础协作、seat / billing 风险可见性、workspace entitlement inheritance、workspace downgrade compensation 和 team ops metrics，但更完整的团队账单生命周期与订阅运营闭环还没补齐
