...
- Free / Pro / Team entitlement helper、billing profile、watchlist + saved views + team workspace 数据模型、seat-aware workspace billing state、workspace entitlement inheritance、Stripe portal / lifecycle sync、Markdown report export、Team Workspace ops metrics
...
- 商业化已经有 billing profile、portal、watchlist、saved views、Markdown brief export、Team Workspace 基础协作、seat / billing 风险可见性、workspace entitlement inheritance 和 team ops metrics，但 PDF / 分享交付、团队账单生命周期和更完整的订阅运营闭环还没补齐
