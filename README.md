...
- 账号中心：订阅状态、权益概览、账单入口、已保存 watchlist / saved views
...
- Free / Pro / Team entitlement helper、billing profile、watchlist + saved views 数据模型、Stripe portal / lifecycle sync、Markdown report export
...
- 商业化已经有 billing profile、portal、watchlist、saved views 和 Markdown brief export，但更完整的 PDF / 分享交付、团队协作和订阅运营闭环还没补齐
