...
- Free / Pro / Team entitlement helper、billing profile、watchlist + saved views + public brief share + team workspace 数据模型、seat-aware workspace billing state、workspace entitlement inheritance、Stripe portal / lifecycle sync、Markdown / PDF report export、Team Workspace ops metrics
...
- 商业化已经有 billing profile、portal、watchlist、saved views、Markdown / PDF brief export、public brief share、Team Workspace 基础协作、seat / billing 风险可见性、workspace entitlement inheritance 和 team ops metrics，但团队账单生命周期和更完整的订阅运营闭环还没补齐
