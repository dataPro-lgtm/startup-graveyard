...
- 账号中心：订阅状态、权益概览、账单入口、已保存 watchlist / saved views、带 seat / billing 状态的 Team Workspace 协作面板
...
- Free / Pro / Team entitlement helper、billing profile、watchlist + saved views + team workspace 数据模型、seat-aware workspace billing state、Stripe portal / lifecycle sync、Markdown report export
...
- 商业化已经有 billing profile、portal、watchlist、saved views、Markdown brief export、Team Workspace 基础协作以及 seat / billing 风险可见性，但 seat 继承权益、PDF / 分享交付和更完整的订阅运营闭环还没补齐
